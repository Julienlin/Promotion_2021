...
biblioth\`eques aux architectures multi-c{\oe}urs avec m\'emoire partag\'ee et aux diff\'erents protocols r\'eseaux.
...
\item Quelque chose qui devrait améliorer les performances du programme car il permet l'envoi et
...
\begin{enumerate}
 ...
 \item Pour déboguer votre programme, n'hésitez pas à écrire des messages avant et après envoie/réception de messages, suivit d'un
...
d'appel à des fonctions d'envoie/réception point à point
\end{minipage} }
