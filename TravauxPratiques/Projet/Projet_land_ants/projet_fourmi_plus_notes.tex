...
\subsection{Création de l'environnement}\marginnote{\emph{Il faut tirer avantage
    de l'algorithme de création de la carte.}}
...
\marginnote{\emph{utilisation de allreduce.}} Une fois toutes les valeurs générées, on les normalise pour obtenir une carte de
...
L'idée ici est que \underline{chaque processus contienne l'environnement en
  entier} \marginnote{\textit{échange du labyrinthe entre les différents procs}}
et \underline{ne contrôle qu'une}\\\underline{partie des
  fourmis}\reversemarginpar\marginnote{\textit{répartition des fourmis par proc}} tandis que lors de la mise à jour des phéromones lors de la phase d'évaporation, chaque processus s'occupe d'une partie de la carte pour laquelle il calculera l'évaporation, à l'aide d'une parallélisation OpenMP si besoin.

\reversemarginpar\marginnote{\emph{Cas MAJ phen}}Lorsque deux fourmis
...
cellule donnée !\marginnote{\emph{la MAJ des phéromones doit être
  échangé entre les procs}}
